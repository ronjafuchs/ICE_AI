...
class WritingAgent(AIInterface):
    def __init__(self):
        super().__init__()
    ...
    def processing(self):
        ...
        if self.cc.get_skill_flag():
            ...
            #print(input)
            self.cc.command_call(np.random.choice(self.allowed_values))
    ...
    def game_end(self):
        ...
        self.save_frame.to_csv("data_range.csv", mode="a", header=False, index=False)
