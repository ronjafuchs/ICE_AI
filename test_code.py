from river.multiclass import OutputCodeClassifier
...
def objective(params):
    ...
    coding_params = armf_params.pop("code_params")
    ...
    classifier = OutputCodeClassifier(
        ...
        code_size=coding_params["code_size"],
        seed=42,
    )
    classifier_wrapped = (
...
space = {
    ...
    "code_params": {
        "code_size": hp.uniformint("code_size", 30, 200),
    },
}
